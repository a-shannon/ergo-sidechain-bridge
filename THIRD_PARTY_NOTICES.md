...
| Ergo node source patches | `sources/ergo-node/0002-sidechain-extension-fields-candidate-recovery.patch` and historical `sources/ergo-node/0001-sidechain-extension-fields.patch` | `ergoplatform/ergo` at commit `2cdbb8cf09d7ccbc060e1022e3c15bcf6a9991b1` | Upstream source and patch context are under CC0-1.0; bridge-authored additions are also available under the repository Apache-2.0 terms |
