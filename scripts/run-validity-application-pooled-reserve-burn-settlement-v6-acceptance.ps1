...
$ExpectedFixtureBuilderSha256 =
  '3abd83f26071b5c2522f41a104a505478703d28a0fd851e358fa27469cb0dbcc'
$ExpectedFixtureScriptSha256 =
  '6e5b9025dc06171de489ec595a4a2bc5f23d2e80557d57e06715ebf162e5e769'
$ExpectedSettlementBuilderSha256 =
  '2d854fe1daca69fb2b16fafb95dbb12e5cd68f5e01d026b366c294e4996c5d17'
$ExpectedInstanceAdapterSha256 =
  '9b9668788a52aba43578be4c4b37687e6e7f28342991487bb0e5f167f7131eb1'
$ExpectedCompilerFixtureSha256 =
  '51c08045ccb7fd207cd78a5af99802499be13a8998e0b88af7fd8bfdd6c51abd'
$LockSchema =
  'e2s.validity-application-pooled-reserve-burn-family-compiler-lock.v6'
$SpecRelativePath =
  'validity-proof/consumer-jvm/BridgeValidityApplicationPooledReserveBurnSettlementV6AcceptanceSpec.scala'
$FixtureBuilderRelativePath =
  'relayer/src/validity-application-pooled-reserve-burn-settlement-v6-fixture.ts'
$FixtureScriptRelativePath =
  'relayer/src/scripts/build-validity-application-pooled-reserve-burn-settlement-v6-jvm-fixture.ts'
$SettlementBuilderRelativePath =
  'relayer/src/validity-application-pooled-reserve-burn-settlement-v6.ts'
$InstanceAdapterRelativePath =
  'relayer/src/validity-application-pooled-reserve-instance-v6.ts'
$CompilerFixtureRelativePath =
  'relayer/src/validity-application-pooled-reserve-burn-family-v6-fixture.ts'
$LockRelativePath =
  'validity-proof/consumer-jvm/validity-application-pooled-reserve-burn-family-compiler-lock-v6.json'
$ReceiptRelativePath =
  'relayer/test-vectors/validity-application-pooled-reserve-compiler-v6.json'
$SpecDestination =
  'sc/shared/src/test/scala/sigma/bridge/BridgeValidityApplicationPooledReserveBurnSettlementV6AcceptanceSpec.scala'
$SpecClass =
  'sigma.bridge.BridgeValidityApplicationPooledReserveBurnSettlementV6AcceptanceSpec'
...
foreach ($entry in @(
  ...
  @($settlementBuilderPath, 'V6 settlement builder'),
  @($instanceAdapterPath, 'V6 compiled-instance adapter'),
  @($compilerFixturePath, 'V6 compiler request fixture'),
...
$runRoot = Join-Path `
  $tempRoot `
  ("bridge-pooled-reserve-burn-v6-acceptance-" +
    ...
    try {
      $acceptanceOutput = @(
        & $javaExe `
          ...
          "-Dbridge.validity.application.pooled.reserve.burn.v6.fixture=$fixturePath" `
          "-Dbridge.validity.application.pooled.reserve.burn.v6.fixture.sha256=$ExpectedFixtureSha256" `
          '-jar' `
          $sbtLauncher `
