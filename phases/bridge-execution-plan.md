...
frozen foundations + selected launch mode + fresh-owner application execution
  ...
  -> same-target native burn/checkpoint and Ergo payout [next composed join]
...
|---|---|---|---|
| **Now** | Reviewed candidate lifecycle -> fresh complete native roundtrip | Freeze a fresh runner against cumulative Ergo overlay 0002 and execute one complete retained-custody roundtrip | Candidate context alignment, exact post-genesis semantic-rejection recovery and stale-solution rejection pass native checks. The locked node builds without starting a service. Use fresh custody and state; campaigns through 21 remain terminal. Campaign 21's exact cause and canonical payout remain unestablished |
