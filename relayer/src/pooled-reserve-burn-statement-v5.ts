...
import {
  ...
  POOLED_RESERVE_BURN_APPLICATION_BINDING_V5_VERSION,
...
export const POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_DOMAIN =
  'E2S_POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5' as const;
export const POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_VERSION = 5 as const;
export const POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_HASH_BLAKE2B256 = 1 as const;
export const POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_SOURCE_SUBSTRATE_GRANDPA_V1 =
  1 as const;
export const POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_FLAGS_NONE = 0 as const;
export const POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_BYTES = 981 as const;
export const EIP0045_POOLED_RESERVE_BURN_STATEMENT_V5_BYTES = 1_140 as const;
export const POOLED_RESERVE_BURN_STATEMENT_V5_DOMAIN =
  'E2S_POOLED_RESERVE_BURN_STATEMENT_V5' as const;
export const POOLED_RESERVE_BURN_V5_REJECTED_APPLICATION_V2_PROGRAM_ID_HEX =
...
const BINDING_RUNTIME_PROFILE_OFFSET = 1;
...
const PUBLIC_INPUTS_BINDING_DIGEST_OFFSET =
  PUBLIC_INPUTS_BINDING_OFFSET + POOLED_RESERVE_BURN_APPLICATION_BINDING_V5_BYTES;
...
export interface PooledReserveBurnApplicationBindingV5Input {
...
export type PooledReserveBurnApplicationBindingV5PrefixInput = Omit<
  PooledReserveBurnApplicationBindingV5Input,
  'settlementTrackerContractIdHex'
>;

export interface PooledReserveBurnApplicationBindingV5 {
...
export interface PooledReserveBurnPublicInputsV5Input {
...
export interface PooledReserveBurnPublicInputsV5 {
  readonly version: 5;
  readonly hashAlgorithmId: 1;
  readonly sourceSemanticsId: 1;
  readonly flags: 0;
  readonly application: Readonly<PooledReserveBurnApplicationBindingV5>;
...
export interface Eip0045PooledReserveBurnStatementV5Input {
...
export interface Eip0045PooledReserveBurnStatementV5 {
  readonly version: 1;
  readonly chainDomainIdHex: string;
  readonly profileIdHex: string;
  readonly programIdHex: string;
  readonly contractIdHex: string;
  readonly publicInputs: Readonly<PooledReserveBurnPublicInputsV5>;
  readonly encodedStatementHex: string;
  readonly statementDigestHex: string;
}

export function encodePooledReserveBurnApplicationBindingV5(
  input: PooledReserveBurnApplicationBindingV5Input,
): Buffer {
  const prefix = encodePooledReserveBurnApplicationBindingV5Prefix(input);
  ...
  if (binding.length !== POOLED_RESERVE_BURN_APPLICATION_BINDING_V5_BYTES) {
    throw new Error('pooled-reserve burn application binding V5 internal length mismatch');
  }
  decodePooledReserveBurnApplicationBindingV5(binding);
  return binding;
}

export function encodePooledReserveBurnApplicationBindingV5Prefix(
  input: PooledReserveBurnApplicationBindingV5PrefixInput,
): Buffer {
  decodePooledReserveMintReservationRuntimeProfileV4ScaleHex(
  ...
  const prefix = Buffer.concat([
    Buffer.from([POOLED_RESERVE_BURN_APPLICATION_BINDING_V5_VERSION]),
    runtimeProfileBytes,
    runtimeProfileId,
    sourceRuntimeCodeSha256,
  ...
  if (
    ...
    throw new Error(
      'pooled-reserve burn application binding V5 prefix internal length mismatch',
    );
  }
  return prefix;
}

export function decodePooledReserveBurnApplicationBindingV5(
  ...
  if (bytes[0] !== POOLED_RESERVE_BURN_APPLICATION_BINDING_V5_VERSION) {
    throw new Error('unsupported pooled-reserve burn application binding version');
  }
  ...
  return Object.freeze({
    formatVersion: POOLED_RESERVE_BURN_APPLICATION_BINDING_V5_VERSION,
    runtimeProfile,
    runtimeProfileScaleHex,
...
export function derivePooledReserveBurnApplicationBindingV5DigestHex(
  input: PooledReserveBurnApplicationBindingV5Input | Buffer | string,
): string {
  const bytes = Buffer.isBuffer(input) || typeof input === 'string'
    ...
    : encodePooledReserveBurnApplicationBindingV5(input);
  return decodePooledReserveBurnApplicationBindingV5(bytes).bindingDigestHex;
}

export function encodePooledReserveBurnPublicInputsV5(
  input: PooledReserveBurnPublicInputsV5Input,
): Buffer {
  ...
  const application = decodePooledReserveBurnApplicationBindingV5(applicationBinding);
  ...
  const publicInputs = Buffer.concat([
    Buffer.from(POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_DOMAIN, 'ascii'),
    Buffer.from([0]),
    Buffer.from([
      POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_VERSION,
      POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_HASH_BLAKE2B256,
      POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_SOURCE_SUBSTRATE_GRANDPA_V1,
      POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_FLAGS_NONE,
    ]),
    applicationBinding,
  ...
  if (publicInputs.length !== POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_BYTES) {
    throw new Error('pooled-reserve burn public inputs V5 internal length mismatch');
  }
  decodePooledReserveBurnPublicInputsV5(publicInputs);
  return publicInputs;
}

export function decodePooledReserveBurnPublicInputsV5(
  encodedPublicInputs: Buffer | string,
): PooledReserveBurnPublicInputsV5 {
  const bytes = exactBytes(
    encodedPublicInputs,
  ...
  if (!bytes.subarray(0, PUBLIC_INPUTS_DISCRIMINATOR_OFFSET).equals(expectedDomain)) {
    throw new Error('pooled-reserve burn public inputs V5 domain mismatch');
  }
  ...
  const checkpoint = Object.freeze({
    ...decodeBridgeCheckpointV1(encodedCheckpoint),
  });
  validateCheckpoint(checkpoint, application.runtimeProfile);
  ...
  return Object.freeze({
    version: POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_VERSION,
    hashAlgorithmId: POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_HASH_BLAKE2B256,
    sourceSemanticsId:
      POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_SOURCE_SUBSTRATE_GRANDPA_V1,
    flags: POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_FLAGS_NONE,
    application,
...
export function derivePooledReserveBurnPublicInputsV5DigestHex(
  encodedPublicInputs: Buffer | string,
): string {
  return decodePooledReserveBurnPublicInputsV5(encodedPublicInputs).publicInputsDigestHex;
}

export function encodeEip0045PooledReserveBurnStatementV5(
  input: Eip0045PooledReserveBurnStatementV5Input,
): Buffer {
  ...
  const decodedPublicInputs = decodePooledReserveBurnPublicInputsV5(publicInputs);
  ...
  if (statement.length !== EIP0045_POOLED_RESERVE_BURN_STATEMENT_V5_BYTES) {
    throw new Error('EIP-0045 pooled-reserve burn statement V5 internal length mismatch');
  }
  return statement;
}

export function decodeEip0045PooledReserveBurnStatementV5(
  encodedStatement: Buffer | string,
): Eip0045PooledReserveBurnStatementV5 {
  const bytes = exactBytes(
    encodedStatement,
  ...
  if (publicInputsLength !== POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_BYTES) {
  ...
  rejectApplicationV2ProgramIdentity(programId);
  const publicInputs = decodePooledReserveBurnPublicInputsV5(
...
export function deriveEip0045PooledReserveBurnStatementV5DigestHex(
  encodedStatement: Buffer | string,
): string {
  return decodeEip0045PooledReserveBurnStatementV5(encodedStatement).statementDigestHex;
}

export function assertEip0045PooledReserveBurnStatementV5Matches(
  encodedStatement: Buffer | string,
  expected: Eip0045PooledReserveBurnStatementV5Input,
): Eip0045PooledReserveBurnStatementV5 {
  const actual = decodeEip0045PooledReserveBurnStatementV5(encodedStatement);
  const rebuilt = encodeEip0045PooledReserveBurnStatementV5(expected);
  if (actual.encodedStatementHex !== rebuilt.toString('hex')) {
    throw new Error('EIP-0045 pooled-reserve burn statement V5 expected binding mismatch');
  }
  return actual;
}
...
function validatePublicInputsDiscriminators(
  ...
  if (version !== POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_VERSION) {
    throw new Error(`unsupported pooled-reserve burn public inputs version: ${version}`);
  }
  if (hashAlgorithmId !== POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_HASH_BLAKE2B256) {
  ...
  if (flags !== POOLED_RESERVE_BURN_PUBLIC_INPUTS_V5_FLAGS_NONE) {
...
function rejectApplicationV2ProgramIdentity(programId: Buffer): void {
  if (
    ...
    throw new Error('pooled-reserve burn V5 must not reuse the application V2 programId');
  }
}
