...
import {
  type BuildValidityApplicationPooledReserveBurnFamilyV6CompilerRequestInput,
...
export function buildValidityApplicationPooledReserveBurnFamilyV6CompilerFixture():
Promise<Readonly<
  ValidityApplicationPooledReserveBurnFamilyV6CompilerRequest
>> {
...
async function buildFixture(): Promise<Readonly<
  ValidityApplicationPooledReserveBurnFamilyV6CompilerRequest
>> {
  return buildValidityApplicationPooledReserveBurnFamilyV6CompilerRequest(
    await buildValidityApplicationPooledReserveBurnFamilyV6CompilerFixtureInput(),
  );
}

export async function buildValidityApplicationPooledReserveBurnFamilyV6CompilerFixtureInput():
Promise<BuildValidityApplicationPooledReserveBurnFamilyV6CompilerRequestInput> {
...
async function buildGenesisBoxes(): Promise<readonly [
  ...
  }, 'pooled-reserve burn-family V6 compiler genesis fixture');
  return [
