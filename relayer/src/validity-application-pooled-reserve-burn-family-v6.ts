...
export const VALIDITY_APPLICATION_POOLED_RESERVE_BURN_FAMILY_V6_COMPILER_REQUEST_SCHEMA =
  'e2s.validity-application-pooled-reserve-burn-family-compiler-request.v6' as const;
export const VALIDITY_APPLICATION_POOLED_RESERVE_BURN_FAMILY_V6_IDENTITY_SCHEMA =
  'e2s.validity-application-pooled-reserve-burn-family-identity.v6' as const;
export const VALIDITY_APPLICATION_POOLED_RESERVE_BURN_FAMILY_V6_COMPILER_BATCH_SHA256_HEX =
  '302db270a82d2492e52e3adaa7cfdb259f8e6bb6e452c34e563a7c85455a5b56' as const;
export const VALIDITY_APPLICATION_POOLED_RESERVE_BURN_FAMILY_V6_CONTRACT_IDS =
  Object.freeze({
    tracker:
    ...
    sourceLock:
      'd151c4dd266846e645d9a133cf825beb745d4047ec900210359f6faeca30afa1',
    pooledReserve:
      '6aa92a05622a5e6490285b06e6e3654e3900495873195a364ad58b9fe22e1bfc',
  } as const);

const CONTRACT_PATHS = Object.freeze({
  tracker: 'contracts/SPVTrackerPooledReserveBurnSettlementV6.es',
  duplicatePrevention:
...
export interface ValidityApplicationPooledReserveBurnFamilyV6Template {
  readonly relativePath: string;
  readonly source: string;
}

export interface BuildValidityApplicationPooledReserveBurnFamilyV6CompilerRequestInput {
  readonly templates: Readonly<Record<
    ContractRole,
    ValidityApplicationPooledReserveBurnFamilyV6Template
  >>;
  readonly genesis: {
...
export interface ValidityApplicationPooledReserveBurnFamilyV6CompilerRequest {
  readonly schema:
    typeof VALIDITY_APPLICATION_POOLED_RESERVE_BURN_FAMILY_V6_COMPILER_REQUEST_SCHEMA;
  readonly version: 6;
...
export interface ValidityApplicationPooledReserveBurnFamilyV6Identity {
  readonly schema:
    typeof VALIDITY_APPLICATION_POOLED_RESERVE_BURN_FAMILY_V6_IDENTITY_SCHEMA;
  readonly version: 6;
  readonly compilerBatchSha256Hex:
    typeof VALIDITY_APPLICATION_POOLED_RESERVE_BURN_FAMILY_V6_COMPILER_BATCH_SHA256_HEX;
  readonly lineageProfileIdHex: string;
  ...
  readonly relations: {
    ...
    readonly applicationBindingBoundIntoPooledReserveViaDuplicatePrevention: true;
  };
  readonly boundaries: {
    readonly profileActivated: false;
    readonly nodeCheckPerformed: false;
...
export async function buildValidityApplicationPooledReserveBurnFamilyV6CompilerRequest(
  input: BuildValidityApplicationPooledReserveBurnFamilyV6CompilerRequestInput,
): Promise<Readonly<
  ValidityApplicationPooledReserveBurnFamilyV6CompilerRequest
>> {
  assertExactKeys(input, [
    ...
    'runtimeBinding',
  ], 'pooled-reserve burn-family V6 compiler request');
  assertExactKeys(input.genesis, [
    'trackerInput',
    'duplicatePreventionInput',
    'pooledReserveInput',
  ], 'pooled-reserve burn-family V6 genesis');
  assertExactKeys(input.templates, [
    'tracker',
    'duplicatePrevention',
    'sourceLock',
    'pooledReserve',
  ], 'pooled-reserve burn-family V6 templates');
  ...
  if (
    ...
    throw new Error(
      'pooled-reserve burn-family V6 must retain the exact compatible V4 source runtime profile',
    );
  }
  ...
  if (
    ...
    throw new Error(
      'pooled-reserve V6 settlement lineage must remain distinct from the V4 source runtime lineage',
    );
  }
  ...
  if (
    ...
    throw new Error('pooled-reserve burn-family V6 prefix length drifted');
  }
...
export function validateValidityApplicationPooledReserveBurnFamilyV6CompilerBatch(
  input: {
    readonly request:
      Readonly<ValidityApplicationPooledReserveBurnFamilyV6CompilerRequest>;
    readonly compilerBatchJson: string;
  },
): Readonly<ValidityApplicationPooledReserveBurnFamilyV6Identity> {
  assertExactKeys(input, [
    'request',
    'compilerBatchJson',
  ], 'pooled-reserve burn-family V6 compiler validation');
  const templates = compilerRequestTemplates.get(input.request);
  if (templates === undefined) {
    throw new Error(
      'pooled-reserve burn-family V6 request must be derived in this process',
    );
  }
  ...
  if (
    ...
    throw new Error(
      'pooled-reserve burn-family V6 compiler batch must be bounded LF-only ASCII JSON',
    );
  }
  if (
    ...
    throw new Error(
      'pooled-reserve burn-family V6 compiler batch SHA-256 is not reviewed',
    );
  }
  ...
  try {
    ...
    throw new Error(
      'pooled-reserve burn-family V6 compiler batch is not valid JSON',
    );
  }
  assertExactKeys(parsed, [
    ...
    'gate5Closed',
  ], 'pooled-reserve burn-family V6 compiler batch');
  ...
  if (
    ...
    throw new Error(
      'pooled-reserve burn-family V6 compiler batch identity is invalid',
    );
  }
  ...
  const trackerSource = resolveTemplate(
    ...
    'pooled-reserve burn-family V6 tracker',
  );
  ...
  if (
    ...
    throw new Error(
      'pooled-reserve burn-family V6 application binding prefix drifted',
    );
  }
  ...
  const duplicatePreventionSource = resolveTemplate(
    ...
    'pooled-reserve burn-family V6 duplicate prevention',
  );
  ...
  const sourceLockSource = resolveTemplate(
    ...
    'pooled-reserve burn-family V6 source lock',
  );
  ...
  const pooledReserveSource = resolveTemplate(
    ...
    'pooled-reserve burn-family V6 reserve',
  );
  ...
  return deepFreeze({
    ...
    relations: {
      ...
      applicationBindingBoundIntoPooledReserveViaDuplicatePrevention:
        true as const,
    },
    boundaries: {
      profileActivated: false as const,
...
function validateCompiledContract(
  ...
  assertExactKeys(value, [
    ...
    'fundsAuthorityEstablished',
    'gate5Closed',
  ], `${expectedRole} burn-family V6 compiler receipt`);
  ...
  if (
    ...
    throw new Error(`${expectedRole} burn-family V6 compiler receipt is invalid`);
  }
  ...
  if (
    ...
    throw new Error(
      `${expectedRole} burn-family V6 proposition identity is invalid`,
    );
  }
  assertFalseCompilerBoundaries(
    receipt,
...
function normalizeTemplates(
  templates: BuildValidityApplicationPooledReserveBurnFamilyV6CompilerRequestInput[
    'templates'
  ],
): NormalizedTemplates {
  return Object.fromEntries(
    (Object.keys(CONTRACT_PATHS) as ContractRole[]).map(role => {
      ...
      if (template.relativePath !== CONTRACT_PATHS[role]) {
        throw new Error(`${role} template path is not the canonical V6 path`);
      }
      if (
...
function normalizeRuntimeBinding(
  ...
  assertExactKeys(input, [
    ...
    'maxPendingBlocks',
  ], 'pooled-reserve burn-family V6 runtime binding');
