# Gate 4 Independent Security External Review Packet - c6fea203
...
| Prerequisite map | ../evidence/security/gate4-independent-security-review-prerequisite-map-2026-07-09-c6fea203.md |
| Command | `npm run security:prerequisite-map -- --candidate ../evidence/security/gate4-independent-security-review-blocker-map-2026-06-26-4ec4f7d1.md --validator-commit c6fea203 --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
