...
| Field | Value |
|---|---|
| Command | npm run trustless:validate -- ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-06-fecc11eb.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-06-fecc11eb.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Required components | 5 | One or more required trustless-burn component rows is not linked as completed Gate 5 evidence |
| Burn proof binding | 1 | One or more burn proof fields lacks exact binding data or completed Gate 5 evidence |
| Positive proof acceptance | 1 | Accepted proof execution evidence is incomplete or not linked |
| Reviewer sign-off | 3 | Protocol, security, or operator reviewer approval is incomplete or inconsistent |
