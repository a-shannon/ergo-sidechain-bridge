# Completed Local Proof-Vector Validation Evidence - 2026-06-25 - 19248ff9
...
|---|---|---|---|
| `npm run trustless:proof-vector:validate -- test-vectors/trustless-burn-proof-v1-multi-leaf.json --json-out ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-06-25-19248ff9.json` | PASS / exit code 0 | `artifact://trustless-burn/completed-local-proof-vector-report-2026-06-25-19248ff9.json` | Read-only local proof-core validation for the multi-leaf proof vector. |
...
- leafCount: 2
- proofNodes: 1
- trustless burn proof-vector report written: ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-06-25-19248ff9.json
```
