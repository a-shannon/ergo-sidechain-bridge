# Completed Gate 5 Local Negative Row Evidence - Wrong Recipient - 2026-06-26 - 174d4cfb

This artifact records row-level local proof-core evidence for the Gate 5
negative-test row "Wrong recipient". It does not close Gate 5, authorize
...
| Field | Value |
|---|---|
| Evidence name | Gate 5 local negative wrong recipient evidence |
| Git commit | 174d4cfb |
...
| Field | Value |
|---|---|
| Negative-test row | Wrong recipient |
| Expected result | rejected |
| Rejected burnId | 548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f |
| Local Proof Vector negativeCase | wrong-recipient |
| Observed proof-core error | settlement recipient must equal proved recipientErgoTreeHash |
