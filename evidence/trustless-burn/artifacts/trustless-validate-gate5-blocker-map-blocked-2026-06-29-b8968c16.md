...
| Field | Value |
|---|---|
| Command | npm run trustless:validate -- ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-29-b8968c16.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-29-b8968c16.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Commitment format | 1 | Commitment fields, encodings, finality, anchoring, or completed commitment evidence are incomplete |
| Burn proof binding | 4 | One or more burn proof fields lacks exact binding data or completed Gate 5 evidence |
