...
| Field | Value |
|---|---|
| Command | npm run trustless:validate -- ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-26-174d4cfb.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-26-174d4cfb.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Commitment format | 9 | Commitment fields, encodings, finality, anchoring, or completed commitment evidence are incomplete |
...
| Negative tests | 3 | One or more required negative trustless-burn rejection cases lacks completed evidence |
