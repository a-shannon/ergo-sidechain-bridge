# Completed Local Proof-Vector Validation Evidence - 2026-06-25 - a5462960
...
|---|---|---|---|
| `npm run trustless:proof-vector:validate -- test-vectors/trustless-burn-proof-v1-multi-leaf.json --json-out ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-06-25-a5462960.json` | PASS / exit code 0 | `artifact://trustless-burn/completed-local-proof-vector-report-2026-06-25-a5462960.json` | Read-only local proof-core validation for the multi-leaf proof vector, including structured fail-closed negative-case observations. |
...
- leafCount: 2
- proofNodes: 1
- trustless burn proof-vector report written: ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-06-25-a5462960.json
```
...
inside a future completed Trustless Burn Verification Evidence package and gives
that package exact local negative-case names plus observed proof-core rejection
strings.
