# Completed Gate 5 Local Negative Row Evidence - Wrong Amount - 2026-06-26 - 174d4cfb

This artifact records row-level local proof-core evidence for the Gate 5
negative-test row "Wrong amount". It does not close Gate 5, authorize
...
| Field | Value |
|---|---|
| Evidence name | Gate 5 local negative wrong amount evidence |
| Git commit | 174d4cfb |
...
| Field | Value |
|---|---|
| Negative-test row | Wrong amount |
| Expected result | rejected |
| Rejected burnId | 548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f |
| Local Proof Vector negativeCase | wrong-amount |
| Observed proof-core error | settlement amount must equal proved amountNanoErg |
