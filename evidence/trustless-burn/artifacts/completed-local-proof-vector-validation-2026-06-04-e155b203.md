# Completed Local Proof-Vector Validation Evidence
...
|---|---|---|---|
| `npm run trustless:proof-vector:validate -- test-vectors/trustless-burn-proof-v1-multi-leaf.json --json-out ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-06-04-e155b203.json` | PASS | `artifact://trustless-burn/completed-local-proof-vector-report-2026-06-04-e155b203.json` | Read-only local proof-core validation for the multi-leaf proof vector. |
...
This evidence records a completed local proof-vector validation report. It can
serve as the proof-vector report binding inside a future completed Trustless
Burn Verification Evidence package.
