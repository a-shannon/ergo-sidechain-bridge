# Completed Local Proof Vector Validation - 2026-07-06 - 39bfec72
...
```powershell
npm run trustless:proof-vector:validate -- test-vectors/trustless-burn-proof-v1-multi-leaf-recipient-tree.json --json-out ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-07-06-fecc11eb.json
```
