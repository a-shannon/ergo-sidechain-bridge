# Completed Local Proof Vector Validation - 2026-07-04 - 136ab3f2
...
```powershell
npm run trustless:proof-vector:validate -- test-vectors/trustless-burn-proof-v1-multi-leaf.json --json-out ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-07-04-136ab3f2.json
```
