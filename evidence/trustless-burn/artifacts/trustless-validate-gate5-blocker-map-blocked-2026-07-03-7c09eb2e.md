...
| Field | Value |
|---|---|
| Command | npm run trustless:validate -- ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-29-5d075bd9.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-29-5d075bd9.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Required components | 6 | One or more required trustless-burn component rows is not linked as completed Gate 5 evidence |
