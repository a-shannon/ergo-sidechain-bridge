...
| Field | Value |
|---|---|
| Command | npm run trustless:validate -- ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-29-de7d0473.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-29-de7d0473.md |
| Result | BLOCKED |
| Exit code | 1 |
| Structural issues | 36 |
...
| Commitment format | 4 | Commitment fields, encodings, finality, anchoring, or completed commitment evidence are incomplete |
