...
| Field | Value |
|---|---|
| Command | npm run trustless:validate -- ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-26-9d5927a1.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-26-9d5927a1.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Negative tests | 1 | One or more required negative trustless-burn rejection cases lacks completed evidence |
