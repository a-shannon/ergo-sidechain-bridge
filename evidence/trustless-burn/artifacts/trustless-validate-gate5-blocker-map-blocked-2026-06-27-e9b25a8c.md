...
| Field | Value |
|---|---|
| Command | npm run trustless:validate -- ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-27-e9b25a8c.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-27-e9b25a8c.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Required components | 8 | One or more required trustless-burn component rows is not linked as completed Gate 5 evidence |
...
- Required Components: Burn commitment tree: status must be linked before Gate 5 evidence can pass
