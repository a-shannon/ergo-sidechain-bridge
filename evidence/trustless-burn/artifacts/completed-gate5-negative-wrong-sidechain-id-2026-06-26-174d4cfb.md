# Completed Gate 5 Local Negative Row Evidence - Wrong Sidechain ID - 2026-06-26 - 174d4cfb

This artifact records row-level local proof-core evidence for the Gate 5
negative-test row "Wrong sidechain ID". It does not close Gate 5, authorize
...
| Field | Value |
|---|---|
| Evidence name | Gate 5 local negative wrong sidechain ID evidence |
| Git commit | 174d4cfb |
...
| Field | Value |
|---|---|
| Negative-test row | Wrong sidechain ID |
| Expected result | rejected |
| Rejected burnId | 548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f |
| Local Proof Vector negativeCase | wrong-sidechain-id |
