...
| Field | Value |
|---|---|
| Command | npm run trustless:validate -- ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-03-541347da.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-03-541347da.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Reviewer sign-off | 4 | Protocol, security, or operator reviewer approval is incomplete or inconsistent |
