# Completed Gate 5 Local Negative Row Evidence - Malformed Inclusion Path - 2026-06-26 - 174d4cfb

This artifact records row-level local proof-core evidence for the Gate 5
negative-test row "Malformed inclusion path". It does not close Gate 5,
...
| Field | Value |
|---|---|
| Evidence name | Gate 5 local negative malformed inclusion path evidence |
| Git commit | 174d4cfb |
...
| Field | Value |
|---|---|
| Negative-test row | Malformed inclusion path |
| Expected result | rejected |
| Rejected burnId | 548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f |
| Local Proof Vector negativeCase | malformed-inclusion-path |
| Observed proof-core error | burn inclusion proof must resolve to bridgeEventRoot |
