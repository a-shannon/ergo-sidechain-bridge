# Gate 5 Trustless Burn Operator Packet - b4995367
...
| Field | Value |
| --- | --- |
| Validator commit | b4995367 |
| Candidate target | ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-03-541347da.md |
| Prerequisite map | ../evidence/trustless-burn/gate5-trustless-burn-prerequisite-map-2026-07-04-b4995367.md |
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-03-541347da.md --validator-commit b4995367 --validator-report-out <report.md> --out <map.md> --operator-packet-out <packet.md>` |
| Current result | BLOCKED |
| Structural issues | 20 |
| Anchoring issues | 1 |
| Tracker/finality issues | 1 |
| Proof acceptance issues | 3 |
| Reviewer approval issues | 5 |
...
| Current proof-vector candidate baseline | Current local proof-vector evidence at ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-07-04-136ab3f2.json plus validation report at ../evidence/trustless-burn/artifacts/completed-local-proof-vector-validation-2026-07-04-136ab3f2.md, and current candidate-only proof-vector settlement evidence at ../evidence/trustless-burn/artifacts/completed-trustless-candidate-proof-vector-2026-07-04-136ab3f2.json plus validation report at ../evidence/trustless-burn/artifacts/completed-trustless-candidate-proof-vector-validation-2026-07-04-136ab3f2.md. | Use these as source-boundary proof-core and candidate-binding inputs only; they do not close Gate 5, prove anchoring or finality, authorize /transactions/check, settlement readiness, signing, submit, or broadcast. |
