# Gate 5 Trustless Burn SPV-Linked Candidate - 2026-07-06 - 39bfec72
...
- artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-07-06-39bfec72.md
- artifact://trustless-burn/artifacts/completed-local-proof-vector-report-2026-07-06-fecc11eb.json
...
| Burn commitment tree | ErgoScript-friendly burn tree using Blake2b-compatible hashing | artifact://trustless-burn/artifacts/completed-gate5-burn-commitment-tree-2026-06-28-a665e48b.md completed Gate 5 burn commitment tree component evidence; Blake2b-compatible local proof-core tree root recorded; recipient-tree proof-vector validation refreshed in artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-07-06-39bfec72.md; no settlement, broadcast, or claim authorization | linked |
| Burn inclusion proof | On-chain proof accepts only included burn events | Local proof-core vector validates in artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-07-06-39bfec72.md, but on-chain Ergo proof acceptance evidence has not been captured | blocker |
| DUP settlement binding | Proved burn ID is the exact DUP key inserted by settlement | Local DUP key binding is recorded in artifact://trustless-burn/artifacts/completed-gate5-duplicate-prevention-key-binding-2026-06-29-b8968c16.md, but completed settlement DUP insertion evidence has not been captured | blocker |
...
../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-07-06-fecc11eb.json
...
|---|---|---|---|
| Valid burn proof acceptance | accepted | local proof-core vector validates in artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-07-06-39bfec72.md, but on-chain Ergo proof acceptance, DUP insertion, settlement payout binding, and accepted settlement transaction evidence have not been captured | blocker |
...
|---|---|---|---|---|
| Protocol reviewer | A. Shannon | block | 2026-07-06 | Recipient-tree local proof-vector validation, burn ID, sidechain transaction hash, sidechain block hash, event index, duplicate-prevention key, recipient hash, amount, inclusion path, finality-rule prerequisite, local reorg-handling prerequisite, and linked local SPV tracker observation are recorded, but Ergo-verifiable sidechain finality, on-chain proof acceptance, DUP settlement insertion, linked 0x04xx anchoring, and independent review still block Gate 5. |
| Security reviewer | unassigned | block | 2026-07-06 | Trustless burn remains blocked until commitment format, burn inclusion proof, SPV tracker observation, stale tracker rejection, reorg rejection, trusted-oracle fallback rejection, and no-broadcast boundaries are independently reviewed. |
| Operator reviewer | unassigned | block | 2026-07-06 | Validate operator recovery, readiness, release-note, checklist, anchor observation closure, and no-broadcast evidence before Gate 5 approval. |
