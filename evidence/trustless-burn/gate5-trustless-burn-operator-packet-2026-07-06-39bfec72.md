# Gate 5 Trustless Burn Operator Packet - 39bfec72
...
| Field | Value |
| --- | --- |
| Validator commit | 39bfec72 |
| Candidate target | ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-06-fecc11eb.md |
| Prerequisite map | ../evidence/trustless-burn/gate5-trustless-burn-prerequisite-map-2026-07-06-39bfec72.md |
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-06-fecc11eb.md --validator-commit 39bfec72 --validator-report-out <report.md> --out <map.md> --operator-packet-out <packet.md>` |
| Current result | BLOCKED |
| Structural issues | 20 |
| Anchoring issues | 1 |
| Tracker/finality issues | 1 |
| Proof acceptance issues | 4 |
