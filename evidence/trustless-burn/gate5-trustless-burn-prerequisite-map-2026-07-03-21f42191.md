# Gate 5 Trustless Burn Prerequisite Map - 21f42191
...
| Field | Value |
| --- | --- |
| Validator commit | 21f42191 |
| Candidate target | ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-29-5d075bd9.md |
| Validator report | ../evidence/trustless-burn/artifacts/trustless-validate-gate5-blocker-map-blocked-2026-07-03-21f42191.md |
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-06-29-5d075bd9.md --validator-commit 21f42191 --validator-report-out <report.md> --out <map.md>` |
