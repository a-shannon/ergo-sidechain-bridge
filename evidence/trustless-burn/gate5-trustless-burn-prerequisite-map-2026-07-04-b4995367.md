# Gate 5 Trustless Burn Prerequisite Map - b4995367
...
| Validator report | ../evidence/trustless-burn/artifacts/trustless-validate-gate5-spv-linked-blocked-2026-07-04-b4995367.md |
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-03-541347da.md --validator-commit b4995367 --validator-report-out <report.md> --out <map.md>` |
...
| --- | --- | --- |
| Reconfirm current Gate 5 blocker map | complete | Validator report above: BLOCKED with 20 structural issue(s). |
