# Gate 5 Trustless Burn Blocker Map - 2026-06-26 - 9d5927a1
...
| Burn commitment tree | ErgoScript-friendly burn tree using Blake2b-compatible hashing | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records a local Blake2b-compatible proof-core bridgeEventRoot, but this is not completed Gate 5 component evidence | blocker |
...
|---|---|---|---|
| sidechainId | 1111111111111111111111111111111111111111111111111111111111111111 | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records the local proof-vector sidechain ID, but this is not completed Gate 5 commitment-format evidence | blocker |
...
| bridgeEventRoot | 1db43125ab9e2f51bc27b988beb50d51f28e4801750b27e0cc7d80c840156acb | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records the local bridgeEventRoot, but on-chain commitment evidence has not been captured | blocker |
| ergoAnchorHeight | 987654 | artifact://trustless-burn/artifacts/gate5-spv-tracker-boundary-public-boundary-2026-06-26-9d5927a1.md records synthetic boundary-only anchorHeight=987654; mined Ergo anchor binding has not been captured | blocker |
| commitmentPrefix | 0x0401 under 0x04xx extension keyspace | artifact://trustless-burn/artifacts/gate5-extension-boundary-public-boundary-2026-06-26-9d5927a1.md records synthetic 0x0401 extension-shape prerequisite evidence; mined-block anchoring has not been captured | blocker |
| hashFunction | Blake2b-compatible hashing in local proof-core | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records local proof-core hashing, but contract-level hash-function evidence has not been captured | blocker |
...
|---|---|---|---|
| burnId | 548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records local proof-core rejection when burnId diverges from the derived sidechain event identity | blocker |
| recipientErgoTreeHash | recipientErgoTreeHash 8888888888888888888888888888888888888888888888888888888888888888 | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records local proof-core recipient binding | blocker |
| amountNanoErg | amountNanoErg 2000000 | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records local proof-core amount binding | blocker |
| sidechainTxHash | 6666666666666666666666666666666666666666666666666666666666666666 | local proof-vector leaf value is present, but sidechain transaction inclusion evidence has not been captured | blocker |
| sidechainBlockHash | 2222222222222222222222222222222222222222222222222222222222222222 | local proof-vector leaf value is present, but finalized sidechain block evidence has not been captured | blocker |
| eventIndex | 8 | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records local proof-core rejection when eventIndex changes the derived identity | blocker |
| inclusionPath | burn inclusion proof must resolve to bridgeEventRoot | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records local proof-core inclusion-path rejection | blocker |
| duplicatePreventionKey | duplicatePreventionKey equals burnId 548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f | artifact://trustless-burn/artifacts/completed-local-proof-vector-validation-2026-06-26-9d5927a1.md records local proof-core duplicate-prevention binding | blocker |
...
|---|---|---|---|---|
| Protocol reviewer | A. Shannon | block | 2026-06-26 | Local proof-core validation, candidate-only duplicate-prevention derivation, and local unfinalized sidechain receipt rejection are recorded, but Ergo-verifiable sidechain finality, SPV or tracker commitment history, on-chain proof acceptance, DUP settlement insertion, reorg handling, 0x04xx anchoring, and independent review still block Gate 5 |
| Security reviewer | unassigned | block | 2026-06-26 | Review commitment format, burn inclusion proof, stale tracker rejection, reorg rejection, trusted-oracle fallback rejection, and no-broadcast boundaries before Gate 5 approval |
| Operator reviewer | unassigned | block | 2026-06-26 | Validate operator recovery, readiness, release-note, checklist, and no-broadcast evidence before Gate 5 approval |
