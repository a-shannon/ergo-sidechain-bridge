...
| Target | Value |
| --- | --- |
| Instance binding | ../evidence/trustless-burn/gate5-trustless-burn-instance-binding-2026-07-09-ace3896d.md |
...
| Unsigned TX validation report | ../evidence/trustless-burn/artifacts/completed-local-trustless-compact-unsigned-tx-validation-2026-07-09-d198839b.md |
| Unsigned TX JSON | ../evidence/trustless-burn/artifacts/completed-local-trustless-compact-unsigned-tx-2026-07-09-d198839b.json |
| Contract-equivalent acceptance JSON | ../evidence/trustless-burn/artifacts/completed-local-contract-acceptance-2026-07-09-c3612838.json |
...
| Check | Status | Detail |
| --- | --- | --- |
| Instance binding Markdown matches JSON identity | pass | binding target ../evidence/trustless-burn/gate5-trustless-burn-instance-binding-2026-07-09-ace3896d.md carries burnId 548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f |
...
| Unsigned TX validation report target matches JSON target | pass | validated target ../evidence/trustless-burn/artifacts/completed-local-trustless-compact-unsigned-tx-2026-07-09-d198839b.json |
...
| Contract-equivalent acceptance JSON validates | pass | contract-equivalent acceptance target ../evidence/trustless-burn/artifacts/completed-local-contract-acceptance-2026-07-09-c3612838.json |
| Contract-equivalent acceptance JSON is PASS with zero structural issues | pass | contract-equivalent acceptance report PASS / 0 structural issues |
| Contract-equivalent acceptance preserves local-only boundary | pass | contract-equivalent acceptance remains no-VM/no-chain/no-DUP/no-sign/no-broadcast/no-closure evidence |
| Contract-equivalent acceptance identity matches instance | pass | contract-equivalent acceptance burnId=548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f, bridgeEventRoot=701fbd1ae0ca10d0687281f2b5a136e4f784dd96a87814f44a092b0c4eb6ffc9 |
...
- Use this matched local source-boundary chain for burnId 548fdcae1cfce1dcdeedc744894f8d3e2d18d1e20e500205c6ebfa86be7d891f as prerequisite evidence only; it does not close Gate 5.
...
| Contract-equivalent acceptance evidence checked | yes |
