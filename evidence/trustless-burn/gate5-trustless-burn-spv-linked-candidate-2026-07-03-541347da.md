# Gate 5 Trustless Burn SPV-Linked Candidate - 2026-07-03 - 541347da

This packet converts the current trustless-burn proof-vector, candidate-only,
anchor-observation, and SPV tracker observation evidence into the Trustless Burn
Verification Evidence layout. It is not completed Gate 5 trustless-burn evidence
...
- artifact://trustless-burn/anchor-observation-root-bound-testnet-2026-07-03-654b8f25.md
- artifact://trustless-burn/anchor-observation-root-bound-testnet-2026-07-03-654b8f25.json
...
- artifact://trustless-burn/gate5-observation-reconciliation-command-2026-07-03-654b8f25.md
- artifact://trustless-burn/gate5-observation-reconciliation-command-2026-07-03-654b8f25.json
...
| Ergo extension-section anchoring | Commitment embedded under collision-safe `0x04xx` extension keys | artifact://trustless-burn/anchor-observation-root-bound-testnet-2026-07-03-654b8f25.md records read-only testnet 0x0401 extension observation for bridgeEventRoot 1db43125ab9e2f51bc27b988beb50d51f28e4801750b27e0cc7d80c840156acb over heights 429317-429556; result remains BLOCKED because no matching bridgeEventRoot was observed; mined-block anchoring, linked anchor observation, contract evidence, settlement, broadcast, and claim authorization have not been captured | blocker |
...
|---|---|---|---|---|
| Protocol reviewer | A. Shannon | block | 2026-07-03 | Local proof-core validation, burn ID, sidechain transaction hash, sidechain block hash, event index, duplicate-prevention key, recipient hash, amount, inclusion path, finality-rule prerequisite, settlement payout binding prerequisite, local reorg-handling prerequisite, candidate-only duplicate-prevention derivation, local unfinalized sidechain receipt rejection, and linked local SPV tracker observation are recorded, but Ergo-verifiable sidechain finality, on-chain proof acceptance, DUP settlement insertion, linked 0x04xx anchoring, and independent review still block Gate 5 |
| Security reviewer | unassigned | block | 2026-07-03 | Review commitment format, burn inclusion proof, SPV tracker observation, stale tracker rejection, reorg rejection, trusted-oracle fallback rejection, and no-broadcast boundaries before Gate 5 approval |
| Operator reviewer | unassigned | block | 2026-07-03 | Validate operator recovery, readiness, release-note, checklist, anchor observation closure, and no-broadcast evidence before Gate 5 approval |
