# Gate 5 Trustless Burn Operator Packet - 2401733f
...
| Field | Value |
| --- | --- |
| Validator commit | 2401733f |
| Candidate target | ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-07-faf05c0b.md |
| Prerequisite map | ../evidence/trustless-burn/gate5-trustless-burn-prerequisite-map-2026-07-07-2401733f.md |
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-07-faf05c0b.md --validator-commit 2401733f --validator-report-out <report.md> --out <map.md> --operator-packet-out <packet.md>` |
...
| Current proof-vector candidate baseline | Current Gate 5 candidate ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-07-faf05c0b.md, trustless-burn validator report ../evidence/trustless-burn/artifacts/trustless-validate-gate5-spv-linked-blocked-2026-07-07-2401733f.md, and proof-vector validation report ../evidence/trustless-burn/artifacts/completed-local-proof-vector-report-2026-07-07-faf05c0b.json. | Use these current targets as source-boundary proof-core and candidate-binding inputs only; they do not close Gate 5, prove anchoring or finality, authorize /transactions/check, settlement readiness, signing, submit, or broadcast. |
