# Gate 5 Trustless Burn Prerequisite Map - 6e06a962
...
| Field | Value |
| --- | --- |
| Validator commit | 6e06a962 |
| Candidate target | ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-07-03-1a24c7ae.md |
| Validator report | ../evidence/trustless-burn/artifacts/trustless-validate-gate5-blocker-map-blocked-2026-07-03-6e06a962.md |
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-blocker-map-2026-07-03-1a24c7ae.md --validator-commit 6e06a962 --validator-report-out <report.md> --out <map.md>` |
...
| --- | --- | --- |
| Reconfirm current Gate 5 blocker map | complete | Validator report above: BLOCKED with 21 structural issue(s). |
