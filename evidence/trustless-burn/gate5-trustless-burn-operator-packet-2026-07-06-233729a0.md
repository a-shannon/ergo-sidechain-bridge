# Gate 5 Trustless Burn Operator Packet - 233729a0
...
| Field | Value |
| --- | --- |
| Validator commit | 233729a0 |
| Candidate target | ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-03-541347da.md |
| Prerequisite map | ../evidence/trustless-burn/gate5-trustless-burn-prerequisite-map-2026-07-06-233729a0.md |
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-03-541347da.md --validator-commit 233729a0 --validator-report-out <report.md> --out <map.md> --operator-packet-out <packet.md>` |
