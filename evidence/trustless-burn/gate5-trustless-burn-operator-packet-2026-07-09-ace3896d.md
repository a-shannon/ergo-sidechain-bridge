# Gate 5 Trustless Burn Operator Packet - ace3896d
...
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-07-faf05c0b.md --validator-commit ace3896d --validator-report-out <report.md> --out <map.md> --operator-packet-out <packet.md>` |
