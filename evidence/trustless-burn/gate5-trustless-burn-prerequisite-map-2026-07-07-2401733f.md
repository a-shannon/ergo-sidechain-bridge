# Gate 5 Trustless Burn Prerequisite Map - 2401733f
...
| Validator report | ../evidence/trustless-burn/artifacts/trustless-validate-gate5-spv-linked-blocked-2026-07-07-2401733f.md |
| Command | `npm run trustless:prerequisite-map -- --candidate ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-07-faf05c0b.md --validator-commit 2401733f --validator-report-out <report.md> --out <map.md>` |
...
| Trustless-burn validator report | ../evidence/trustless-burn/artifacts/trustless-validate-gate5-spv-linked-blocked-2026-07-07-2401733f.md |
