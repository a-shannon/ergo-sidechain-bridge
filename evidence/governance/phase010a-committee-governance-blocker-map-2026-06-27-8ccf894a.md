# Phase 010a Committee Governance Blocker Map - 2026-06-27 - 8ccf894a
...
Phase 2 evidence, signer-gated scope source-boundary evidence, current-head
relayer check command evidence, and current-head `npm run contracts:check`
command evidence.
...
- artifact://governance/artifacts/governance-validate-phase010a-blocker-map-blocked-2026-06-27-8ccf894a.md
