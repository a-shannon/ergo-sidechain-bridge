...
| Field | Value |
|---|---|
| Command | npm run governance:validate -- ../evidence/governance/phase010a-committee-governance-blocker-map-2026-06-26-88845fd9.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/governance/phase010a-committee-governance-blocker-map-2026-06-26-88845fd9.md |
| Result | BLOCKED |
| Exit code | 1 |
...
|---|---:|---|
| Scope | 7 | One or more governed surfaces lacks completed authority-transition evidence |
...
| Negative checks | 5 | One or more rejection, broadcast-disabled, or wrong-network negative checks lacks completed evidence |
