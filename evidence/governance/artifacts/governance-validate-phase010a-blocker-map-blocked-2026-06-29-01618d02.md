...
| Field | Value |
|---|---|
| Command | npm run governance:validate -- ..\evidence\governance\phase010a-committee-governance-blocker-map-2026-06-29-01618d02.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ..\evidence\governance\phase010a-committee-governance-blocker-map-2026-06-29-01618d02.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Negative checks | 3 | One or more rejection, broadcast-disabled, or wrong-network negative checks lacks completed evidence |
