...
| Field | Value |
|---|---|
| Command | npm run governance:validate -- ../evidence/governance/phase010a-committee-governance-blocker-map-2026-06-25-3e1a6811.md --report-out <report.md> |
...
| Publication rules | 10 | Governance-ready, release support, open blocker, release-note, checklist, or external review publication fields are incomplete |
