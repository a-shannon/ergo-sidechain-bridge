...
| Field | Value |
|---|---|
| Command | npm run governance:validate -- ../evidence/governance/phase010a-committee-governance-blocker-map-2026-06-26-293351bd.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/governance/phase010a-committee-governance-blocker-map-2026-06-26-293351bd.md |
| Result | BLOCKED |
| Exit code | 1 |
...
|---|---:|---|
| Scope | 8 | One or more governed surfaces lacks completed authority-transition evidence |
| Required commands | 6 | One or more required governance/check commands lacks command-specific completed output evidence |
...
| Negative checks | 6 | One or more rejection, broadcast-disabled, or wrong-network negative checks lacks completed evidence |
...
- Scope: MainChainLock emergency escape path: status must be linked before committee governance evidence can pass
- Scope: SPVTracker ingest authorization: status must be linked before committee governance evidence can pass
- Scope: MCU Phase 2 path: status must be linked before committee governance evidence can pass
- Required Commands: npm run contracts:check: status must be linked before committee governance evidence can pass
- Required Commands: npm run check: status must be linked before committee governance evidence can pass
- Required Commands: npm run wasm:test: status must be linked before committee governance evidence can pass
