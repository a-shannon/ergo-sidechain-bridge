# Phase 010a Committee Governance Blocker Map - 2026-07-02 - cb31d9f3
...
source-boundary evidence, member-loss threshold safety source-boundary
evidence, singleton continuity source-boundary evidence, relayer check command
evidence, `npm run contracts:check` command evidence, completed below-policy
threshold rejection evidence, node-backed synthetic committee guard evidence
for old/new signer behavior, public source-boundary committee identifiers, and
source-boundary rollback-plan evidence. It also links sanitized local
deployment-state reconciliation and wrong-network negative reports produced by
the Gate 6 reconciliation handoff. External review, publication-rule closure,
and reviewer approvals remain blockers.
...
- artifact://governance/artifacts/governance-validate-phase010a-blocker-map-blocked-2026-06-30-1b9b3763.md
- artifact://governance/artifacts/governance-validate-phase010a-blocker-map-blocked-2026-06-29-18cfa41d.md
...
|---|---|---|---|---|
| Governance owner | A. Shannon | block | 2026-07-02 | Validate Gate 6 evidence with committee identities, threshold drill, signer checks, publication updates, and external review before any governance-ready claim |
| Security reviewer | unassigned | block | 2026-07-02 | Validate committee signer negative checks, singleton continuity, no-broadcast boundaries, and external review before any authority-transition claim |
| Operator reviewer | unassigned | block | 2026-07-02 | Validate operator command evidence, status evidence, rollback plan, network reconciliation, and external review before any key-rotation claim |
