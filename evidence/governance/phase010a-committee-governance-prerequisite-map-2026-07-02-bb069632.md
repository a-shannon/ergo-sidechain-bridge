# Phase 010a Committee Governance Prerequisite Map - bb069632
...
| Field | Value |
| --- | --- |
| Validator commit | bb069632 |
| Candidate target | ../evidence/governance/phase010a-committee-governance-blocker-map-2026-07-02-cb31d9f3.md |
| Validator report | ../evidence/governance/artifacts/governance-validate-phase010a-blocker-map-blocked-2026-07-02-bb069632.md |
| Command | `npm run governance:prerequisite-map -- --candidate ../evidence/governance/phase010a-committee-governance-blocker-map-2026-07-02-cb31d9f3.md --validator-commit bb069632 --validator-report-out <report.md> --out <map.md>` |
