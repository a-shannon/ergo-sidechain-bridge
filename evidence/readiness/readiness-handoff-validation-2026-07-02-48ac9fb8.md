...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-2026-07-02-48ac9fb8.json --expected-source-commit 48ac9fb8 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | 48ac9fb8 |
| Expected source commit | 48ac9fb8 |
| Handoff source | ../evidence/readiness/readiness-handoff-2026-07-02-48ac9fb8.json |
