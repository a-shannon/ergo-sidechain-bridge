...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-2026-07-02-c33e5812.json --expected-source-commit c33e5812 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | c33e5812 |
| Expected source commit | c33e5812 |
| Handoff source | ../evidence/readiness/readiness-handoff-2026-07-02-c33e5812.json |
| Live evidence requests | 7 |
| Lane packets | 2 |
| Lane packet covered requests | 7 |
| Operator input checklists | 2 |
| Operator evidence inputs | 8 |
| Structural issues | 0 |
