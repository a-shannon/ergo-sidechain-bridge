...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-6cdf2957.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-02-5dbaa14d.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-observation-export-testnet-2026-07-02-c53f299f.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| Local evidence issues | 31 |
| Local-only closure status | Local Evidence Work Available |
| Local-only closure issues | 31 |
| External/live/claim closure issues | 50 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-6cdf2957.json |
| Node preflight | PASS |
...
- Do not unlock claim/publication fields until node-backed/live-drill, local-only evidence and reviewer/external blockers are resolved.
...
| Gate 7 benchmark | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-bcb15f7a.md |
