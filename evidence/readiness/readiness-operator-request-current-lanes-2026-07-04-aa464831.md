...
| Handoff source | ../evidence/readiness/readiness-handoff-current-lanes-2026-07-04-aa464831.json |
| Local evidence requests | 0 |
| Node-backed or live evidence requests | 10 |
| Reviewer or external requests | 58 |
...
| Trustless burn verification | 0 | 5 | 12 | Use the compact unsigned candidate PASS validation as the source-boundary handoff, then collect the requested non-mainnet proof-acceptance artifacts and run the trustless burn validator on the completed evidence document. |
...
| Supporting packets | ../evidence/trustless-burn/gate5-trustless-burn-operator-packet-2026-07-03-541347da.md |
