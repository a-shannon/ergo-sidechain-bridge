...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-04-aa464831.json --expected-source-commit 541347da --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | 541347da |
| Expected source commit | 541347da |
...
| Lane packets | 4 |
| Lane packet covered requests | 68 |
...
| Trustless burn verification | 17 | 8 | ../docs/trustless-burn-verification-evidence-template.md | npm run trustless:validate -- <completed-trustless-burn-evidence.md> | --trustless-burn-evidence <completed-trustless-burn-evidence.md> |
