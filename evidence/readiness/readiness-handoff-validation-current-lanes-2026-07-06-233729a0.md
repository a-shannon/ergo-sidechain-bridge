...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-06-233729a0.json --expected-source-commit 233729a0 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
