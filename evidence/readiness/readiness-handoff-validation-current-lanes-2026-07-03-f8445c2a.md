...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-f8445c2a.json --expected-source-commit f8445c2a --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | f8445c2a |
| Expected source commit | f8445c2a |
| Handoff source | ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-f8445c2a.json |
