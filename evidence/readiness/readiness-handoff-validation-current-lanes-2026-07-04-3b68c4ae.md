...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-04-3b68c4ae.json --expected-source-commit 3b68c4ae --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | 3b68c4ae |
| Expected source commit | 3b68c4ae |
