...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-7a63a983.json --expected-source-commit 7a63a983 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | 7a63a983 |
| Expected source commit | 7a63a983 |
| Handoff source | ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-7a63a983.json |
