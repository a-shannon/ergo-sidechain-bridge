...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-f8445c2a.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-02-5dbaa14d.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-observation-export-testnet-2026-07-02-c53f299f.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-f8445c2a.json |
| Node preflight | PASS |
