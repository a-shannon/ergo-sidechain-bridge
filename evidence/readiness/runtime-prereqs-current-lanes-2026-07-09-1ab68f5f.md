...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-09-1ab68f5f.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-06-233729a0.json --anchor-preflight-json ../evidence/trustless-burn/anchor-preflight-root-bound-testnet-2026-07-09-a21efc0b.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-lanes-2026-07-09-1ab68f5f.json |
| Node preflight | PASS |
