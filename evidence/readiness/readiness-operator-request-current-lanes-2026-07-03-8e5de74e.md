...
- Trustless burn verification: Collect the requested non-mainnet proof-path artifacts, then run the trustless burn validator on the completed evidence document.
...
| Trustless burn verification | 0 | 6 | 13 | Collect the requested non-mainnet proof-path artifacts, then run the trustless burn validator on the completed evidence document. |
...
| Supporting packets | ../evidence/trustless-burn/gate5-trustless-burn-operator-packet-2026-07-03-21f42191.md |
...
| Current prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-03-b0224fd6.md |
| Supporting packets | ../evidence/benchmarks/gate7-live-benchmark-review-packet-2026-07-03-b0224fd6.md |
...
| Supporting packets | ../evidence/governance/phase010a-committee-governance-external-review-packet-2026-07-03-7f516dcc.md |
