...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-06-30-817f801d.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
