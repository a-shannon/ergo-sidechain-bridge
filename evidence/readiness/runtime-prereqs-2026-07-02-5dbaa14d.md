...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-2026-07-02-5dbaa14d.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-02-5dbaa14d.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-root-bound-testnet-2026-07-02-5dbaa14d.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
