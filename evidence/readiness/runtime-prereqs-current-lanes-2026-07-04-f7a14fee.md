...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-04-f7a14fee.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-04-f7a14fee.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-observation-export-testnet-2026-07-04-8e57c5fd.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-lanes-2026-07-04-f7a14fee.json |
| Node preflight | PASS |
| Node preflight source | json report: ../evidence/readiness/node-preflight-testnet-2026-07-04-f7a14fee.json |
