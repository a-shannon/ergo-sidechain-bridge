...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff -- --runtime-prereqs-json ../evidence/readiness/runtime-prereqs-current-lanes-2026-07-03-2768a62b.json --out <report.md> --json-out <report.json> |
| Handoff result | ACTION_REQUIRED |
| Source commit | 2768a62b |
| Runtime prerequisite result | READY |
| Runtime prerequisite source | ../evidence/readiness/runtime-prereqs-current-lanes-2026-07-03-2768a62b.json |
...
|---|---:|---|---|---|
| Independent security review | 7 | ../docs/independent-security-review-evidence-template.md | npm run security:validate -- <completed-independent-security-review.md> | --security-review-evidence <completed-independent-security-review.md> |
