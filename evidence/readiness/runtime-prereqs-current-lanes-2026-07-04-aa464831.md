...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-541347da.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-02-5dbaa14d.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-observation-export-testnet-2026-07-04-aa464831.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| Anchor preflight source | json report: ../evidence/readiness/anchor-preflight-observation-export-testnet-2026-07-04-aa464831.json |
| Anchor count | 0 |
