...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-395b71b6.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-03-654b8f25.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-root-bound-testnet-2026-07-03-654b8f25.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| External/live/claim closure issues | 81 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-395b71b6.json |
| Node preflight | PASS |
...
| Gate 7 benchmark | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-b0224fd6.md |
