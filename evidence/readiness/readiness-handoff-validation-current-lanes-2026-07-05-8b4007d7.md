...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-05-8b4007d7.json --expected-source-commit 8b4007d7 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | 8b4007d7 |
| Expected source commit | 8b4007d7 |
