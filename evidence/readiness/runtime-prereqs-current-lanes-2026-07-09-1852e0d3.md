...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-2026-07-09-1852e0d3.json --anchor-preflight-json ../evidence/trustless-burn/anchor-preflight-root-bound-testnet-2026-07-09-a21efc0b.json --out <report.md> --json-out <report.json> |
| Result | BLOCKED |
| Exit code | 1 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-2026-07-09-1852e0d3.json |
| Node preflight | BLOCKED |
| Node preflight source | live node probe |
| Anchor preflight | FAIL |
| Anchor preflight source | json report: ../evidence/trustless-burn/anchor-preflight-root-bound-testnet-2026-07-09-a21efc0b.json |
| Anchor count | 0 |
...
- Start or configure a non-mainnet Ergo node at http://127.0.0.1:9052, then rerun npm run readiness:node-preflight -- before collecting node-backed/live-drill evidence.
...
| Node preflight executed | yes |
| Node preflight JSON reused | no |
| Live node probe executed by runtime prerequisites | yes |
| Anchor preflight JSON reused | yes |
| Non-mainnet node prerequisite available | no |
