...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff -- --runtime-prereqs-json ../evidence/readiness/runtime-prereqs-current-lanes-2026-07-04-aa464831.json --out <report.md> --json-out <report.json> |
| Handoff result | ACTION_REQUIRED |
| Source commit | 541347da |
| Runtime prerequisite result | READY |
| Runtime prerequisite source | ../evidence/readiness/runtime-prereqs-current-lanes-2026-07-04-aa464831.json |
| Total unresolved structural issues | 79 |
| Local-only issues | 0 |
| Node-backed/live-drill issues | 10 |
| Reviewer/external issues | 58 |
...
| Reviewer or external decisions | action-required | 58 | Prepare reviewer packets and external decision material after the runtime evidence is concrete. |
...
| Trustless burn verification | 17 | ../docs/trustless-burn-verification-evidence-template.md | npm run trustless:validate -- <completed-trustless-burn-evidence.md> | --trustless-burn-evidence <completed-trustless-burn-evidence.md> |
...
- Triage target: ../evidence/trustless-burn/gate5-trustless-burn-spv-linked-candidate-2026-07-03-541347da.md
- Current prerequisite map: ../evidence/trustless-burn/gate5-trustless-burn-prerequisite-map-2026-07-03-541347da.md
...
- Triage target: ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-866ea4f4.md
- Current prerequisite map: ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-03-866ea4f4.md
