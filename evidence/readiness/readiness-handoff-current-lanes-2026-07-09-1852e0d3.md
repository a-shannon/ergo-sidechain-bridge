...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff -- --runtime-prereqs-json ../evidence/readiness/runtime-prereqs-current-lanes-2026-07-09-1852e0d3.json --out <report.md> --json-out <report.json> |
| Handoff result | ACTION_REQUIRED |
| Source commit | 1852e0d3 |
| Runtime prerequisite result | BLOCKED |
| Runtime prerequisite source | ../evidence/readiness/runtime-prereqs-current-lanes-2026-07-09-1852e0d3.json |
...
| Non-mainnet or live drill evidence | blocked | 10 | Collect concrete node-backed or live-drill evidence for Benchmark and scaling evidence, Independent security review and Trustless burn verification. |
...
- Start or configure a non-mainnet Ergo node at http://127.0.0.1:9052, rerun npm run readiness:node-preflight --, then collect the listed runtime evidence.
