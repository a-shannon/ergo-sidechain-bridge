...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-09-cc9b0417.json --expected-source-commit cc9b0417 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | cc9b0417 |
| Expected source commit | cc9b0417 |
