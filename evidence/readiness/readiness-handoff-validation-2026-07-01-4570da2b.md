...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-lane-packets-2026-07-01-3adafff6.json --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Handoff source | ../evidence/readiness/readiness-handoff-lane-packets-2026-07-01-3adafff6.json |
