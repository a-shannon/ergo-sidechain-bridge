...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-6cdf2957.json --expected-source-commit 6cdf2957 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | 6cdf2957 |
| Expected source commit | 6cdf2957 |
| Handoff source | ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-6cdf2957.json |
...
|---|---:|---:|---|---|---|
| Independent security review | 38 | 4 | ../docs/independent-security-review-evidence-template.md | npm run security:validate -- <completed-independent-security-review.md> | --security-review-evidence <completed-independent-security-review.md> |
