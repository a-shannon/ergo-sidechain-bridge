...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-08-426c6cf6.json --expected-source-commit a3330d46 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
