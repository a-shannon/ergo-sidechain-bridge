...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-541347da.json --expected-source-commit 541347da --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
