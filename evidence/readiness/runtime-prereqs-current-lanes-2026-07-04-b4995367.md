...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-04-b4995367.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-04-3b68c4ae.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-observation-export-testnet-2026-07-04-8e57c5fd.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-lanes-2026-07-04-b4995367.json |
| Node preflight | PASS |
