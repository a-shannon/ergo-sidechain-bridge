...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-2768a62b.json --expected-source-commit 2768a62b --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | 2768a62b |
| Expected source commit | 2768a62b |
| Handoff source | ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-2768a62b.json |
| Live evidence requests | 9 |
| Reviewer/external requests | 29 |
| Lane packets | 4 |
| Lane packet covered requests | 38 |
...
|---|---:|---:|---|---|---|
| Independent security review | 7 | 4 | ../docs/independent-security-review-evidence-template.md | npm run security:validate -- <completed-independent-security-review.md> | --security-review-evidence <completed-independent-security-review.md> |
