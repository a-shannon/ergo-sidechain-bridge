...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff -- --runtime-prereqs-json ../evidence/readiness/runtime-prereqs-current-lanes-2026-07-05-8b4007d7.json --out <report.md> --json-out <report.json> |
| Handoff result | ACTION_REQUIRED |
| Source commit | 8b4007d7 |
| Runtime prerequisite result | READY |
| Runtime prerequisite source | ../evidence/readiness/runtime-prereqs-current-lanes-2026-07-05-8b4007d7.json |
...
- Current prerequisite map: ../evidence/trustless-burn/gate5-trustless-burn-prerequisite-map-2026-07-04-b4995367.md
