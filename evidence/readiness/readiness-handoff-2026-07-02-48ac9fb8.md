...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff -- --runtime-prereqs-json ../evidence/readiness/runtime-prereqs-2026-07-02-48ac9fb8.json --out <report.md> --json-out <report.json> |
| Handoff result | ACTION_REQUIRED |
| Source commit | 48ac9fb8 |
| Runtime prerequisite result | READY |
| Runtime prerequisite source | ../evidence/readiness/runtime-prereqs-2026-07-02-48ac9fb8.json |
...
- Operator evidence inputs:
  ...
  - Observation reconciliation packet: current Gate 5 reconciliation at ../evidence/trustless-burn/gate5-observation-reconciliation-2026-07-02-6953c3b5.md shows anchor observation BLOCKED, SPV tracker linked-local prerequisite evidence, matched bridgeEventRoot, and mismatched ergoAnchorHeight; next packet must bind one shared bridgeEventRoot and ergoAnchorHeight across anchor, SPV, proof-vector, and settlement-binding evidence.
