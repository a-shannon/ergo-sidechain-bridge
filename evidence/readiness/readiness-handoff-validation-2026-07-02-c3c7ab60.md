...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-2026-07-02-c3c7ab60.json --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Handoff source | ../evidence/readiness/readiness-handoff-2026-07-02-c3c7ab60.json |
