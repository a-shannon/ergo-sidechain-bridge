...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-866ea4f4.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-03-654b8f25.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-root-bound-testnet-2026-07-03-654b8f25.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-lanes-2026-07-03-866ea4f4.json |
| Node preflight | PASS |
