...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-b0224fd6.json --expected-source-commit b0224fd6 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | b0224fd6 |
| Expected source commit | b0224fd6 |
| Handoff source | ../evidence/readiness/readiness-handoff-current-lanes-2026-07-03-b0224fd6.json |
