...
| External/live/claim issue count | 81 |
...
| Gate 7 benchmark | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-b0224fd6.md | BLOCKED | 6 | yes |
...
| Node Backed Or Live Drill | 11 | Needs a concrete non-mainnet node-backed/live drill or real target binding; do not infer it from offline text |
