...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-09-1ab68f5f.json --expected-source-commit 1ab68f5f --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | 1ab68f5f |
| Expected source commit | 1ab68f5f |
