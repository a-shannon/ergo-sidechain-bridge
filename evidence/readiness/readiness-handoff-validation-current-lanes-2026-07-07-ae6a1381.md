...
| Field | Value |
|---|---|
| Command | npm run readiness:handoff:validate -- ../evidence/readiness/readiness-handoff-current-lanes-2026-07-07-ae6a1381.json --expected-source-commit ae6a1381 --report-out <report.md> --json-out <report.json> |
| Result | PASS |
| Exit code | 0 |
| Source commit | ae6a1381 |
| Expected source commit | ae6a1381 |
