...
| Field | Value |
|---|---|
| Command | npm run readiness:runtime-prereqs -- --triage-json ../evidence/readiness/readiness-triage-current-lanes-2026-07-07-89442919.json --node-preflight-json ../evidence/readiness/node-preflight-testnet-2026-07-06-233729a0.json --anchor-preflight-json ../evidence/readiness/anchor-preflight-observation-export-testnet-2026-07-06-4987caca.json --out <report.md> --json-out <report.json> |
| Result | READY |
| Exit code | 0 |
...
| Readiness triage source | json report: ../evidence/readiness/readiness-triage-current-lanes-2026-07-07-89442919.json |
| Node preflight | PASS |
...
| Anchor preflight source | json report: ../evidence/readiness/anchor-preflight-observation-export-testnet-2026-07-06-4987caca.json |
| Anchor count | 0 |
