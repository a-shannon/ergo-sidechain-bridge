# Gate 7 Live Benchmark Review Packet - 8100681e
...
| Prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-03-8100681e.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-8100681e.md --validator-commit 8100681e --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
