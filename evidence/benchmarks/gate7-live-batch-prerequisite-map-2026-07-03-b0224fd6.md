# Gate 7 Live Batch Benchmark Prerequisite Map - b0224fd6
...
| Field | Value |
| --- | --- |
| Validator commit | b0224fd6 |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-b0224fd6.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-03-b0224fd6.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-b0224fd6.md --validator-commit b0224fd6 --validator-report-out <report.md> --out <map.md>` |
