# Gate 7 Live Benchmark Capture Manifest - 05f25f0e
...
`npm run benchmark:live-capture-manifest -- --source-commit 05f25f0e --prerequisite-map ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-08-05f25f0e.md --review-packet ../evidence/benchmarks/gate7-live-benchmark-review-packet-2026-07-08-05f25f0e.md --readiness-request ../evidence/readiness/readiness-operator-request-current-lanes-2026-07-08-4937af7b.md --out ../evidence/benchmarks/gate7-live-batch-capture-manifest-2026-07-08-05f25f0e.md`

## Current Inputs

| Input | Current target | Capture status |
| --- | --- | --- |
| Source commit | `05f25f0e` | reference only |
| Gate 7 candidate | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-08-05f25f0e.md | source evidence candidate |
| Gate 7 prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-08-05f25f0e.md | BLOCKED with 6 structural issues |
| Gate 7 review packet | ../evidence/benchmarks/gate7-live-benchmark-review-packet-2026-07-08-05f25f0e.md | 1 live issue, 3 reviewer approval issues, 2 publication-boundary issues |
| Current readiness operator request | ../evidence/readiness/readiness-operator-request-current-lanes-2026-07-08-4937af7b.md | remaining operator inputs |
