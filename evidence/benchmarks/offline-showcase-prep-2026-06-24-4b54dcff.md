# Offline Benchmark Evidence Prep - 2026-06-24 - 4b54dcff
...
|---|---|---|
| npm run showcase:benchmark | PASS / exit code 0 | artifact://benchmarks/artifacts/offline-showcase-benchmark-output-2026-06-24-4b54dcff.md |
| npm run showcase:lanes | PASS / exit code 0 | artifact://benchmarks/artifacts/offline-showcase-lanes-output-2026-06-24-4b54dcff.md |
| npm run showcase:proofs | PASS / exit code 0 | artifact://benchmarks/artifacts/offline-showcase-proofs-output-2026-06-24-4b54dcff.md |
| npm run showcase:finality | PASS / exit code 0 | artifact://benchmarks/artifacts/offline-showcase-finality-output-2026-06-24-4b54dcff.md |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| Batch size 1 | 3.6 ms | 137 B | 67 B | 67 B | n/a | 15 | 3 | 4 |
| Batch size 2 | 0.8 ms | 171 B | 67 B | 68 B | 218 B | 18 | 3 | 5 |
| Batch size 5 | 0.8 ms | 191 B | 67 B | 68 B | 545 B | 33 | 3 | 8 |
| Batch size 10 | 1.6 ms | 225 B | 67 B | 70 B | 1090 B | 58 | 3 | 13 |
...
- artifact://benchmarks/artifacts/benchmark-validate-offline-prep-blocked-2026-06-25-408234b0.md
