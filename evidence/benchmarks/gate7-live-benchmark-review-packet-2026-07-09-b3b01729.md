# Gate 7 Live Benchmark Review Packet - b3b01729
...
| Prerequisite map | ../evidence/benchmarks/gate7-live-benchmark-prerequisite-map-2026-07-09-b3b01729.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-09-b3b01729.md --validator-commit b3b01729 --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
