# Gate 7 Live Batch Benchmark Prerequisite Map - 0f2c3462
...
| Field | Value |
| --- | --- |
| Validator commit | 0f2c3462 |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-02-aa729be2.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-02-0f2c3462.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-02-aa729be2.md --validator-commit 0f2c3462 --validator-report-out <report.md> --out <map.md>` |
