# Gate 7 Live Batch Benchmark Prerequisite Map - 37d1f8f7
...
| Field | Value |
| --- | --- |
| Validator commit | 37d1f8f7 |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-37d1f8f7.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-03-37d1f8f7.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-37d1f8f7.md --validator-commit 37d1f8f7 --validator-report-out <report.md> --out <map.md>` |
