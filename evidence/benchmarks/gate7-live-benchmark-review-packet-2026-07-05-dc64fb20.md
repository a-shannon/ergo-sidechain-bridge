# Gate 7 Live Benchmark Review Packet - dc64fb20
...
| Prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-05-dc64fb20.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-05-dc64fb20.md --validator-commit dc64fb20 --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
