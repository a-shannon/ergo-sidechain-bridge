...
| Source commit | 05f25f0e |
| Capture manifest | ../evidence/benchmarks/gate7-live-batch-capture-manifest-2026-07-08-05f25f0e.md |
...
| Readiness operator request | ../evidence/readiness/readiness-operator-request-current-lanes-2026-07-08-4937af7b.md |
