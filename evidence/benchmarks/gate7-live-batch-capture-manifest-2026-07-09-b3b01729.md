# Gate 7 Live Benchmark Capture Manifest - b3b01729
...
`npm run benchmark:live-capture-manifest -- --source-commit b3b01729 --prerequisite-map ../evidence/benchmarks/gate7-live-benchmark-prerequisite-map-2026-07-09-b3b01729.md --review-packet ../evidence/benchmarks/gate7-live-benchmark-review-packet-2026-07-09-b3b01729.md --out ../evidence/benchmarks/gate7-live-batch-capture-manifest-2026-07-09-b3b01729.md`

## Current Inputs

| Input | Current target | Capture status |
| --- | --- | --- |
| Source commit | `b3b01729` | reference only |
| Gate 7 candidate | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-09-b3b01729.md | source evidence candidate |
| Gate 7 prerequisite map | ../evidence/benchmarks/gate7-live-benchmark-prerequisite-map-2026-07-09-b3b01729.md | BLOCKED with 6 structural issues |
| Gate 7 review packet | ../evidence/benchmarks/gate7-live-benchmark-review-packet-2026-07-09-b3b01729.md | 1 live issue, 3 reviewer approval issues, 2 publication-boundary issues |
