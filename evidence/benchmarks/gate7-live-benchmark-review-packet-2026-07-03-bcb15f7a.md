# Gate 7 Live Benchmark Review Packet - bcb15f7a
...
| Prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-03-bcb15f7a.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-bcb15f7a.md --validator-commit bcb15f7a --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
