# Gate 7 Live Batch Benchmark Prerequisite Map - 54b10663
...
| Field | Value |
| --- | --- |
| Validator commit | 54b10663 |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-08-54b10663.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-08-54b10663.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-08-54b10663.md --validator-commit 54b10663 --validator-report-out <report.md> --out <map.md>` |
