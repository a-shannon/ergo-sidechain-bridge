# Gate 7 Live Batch Benchmark Prerequisite Map - 3b68c4ae
...
| Field | Value |
| --- | --- |
| Validator commit | 3b68c4ae |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-04-3b68c4ae.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-04-3b68c4ae.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-04-3b68c4ae.md --validator-commit 3b68c4ae --validator-report-out <report.md> --out <map.md>` |
