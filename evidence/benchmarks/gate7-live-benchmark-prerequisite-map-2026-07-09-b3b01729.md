# Gate 7 Live Batch Benchmark Prerequisite Map - b3b01729
...
| Field | Value |
| --- | --- |
| Validator commit | b3b01729 |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-09-b3b01729.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-gate7-current-prereq-blocked-2026-07-09-b3b01729.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-09-b3b01729.md --validator-commit b3b01729 --validator-report-out <report.md> --out <map.md>` |
