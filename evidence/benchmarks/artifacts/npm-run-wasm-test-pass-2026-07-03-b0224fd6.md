# npm run wasm:test Command Output - 2026-07-03 - b0224fd6
...
- Rust unit test failures: 0.
- Doc tests: 0 passed, 0 failed.

The benchmark code baseline for this evidence packet is `b0224fd6`; this
command was rerun during the current readiness cycle and produced the summary
above.
