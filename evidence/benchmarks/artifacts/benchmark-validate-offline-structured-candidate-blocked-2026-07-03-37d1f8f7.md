...
| Field | Value |
|---|---|
| Command | npm run benchmark:validate -- ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-37d1f8f7.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-37d1f8f7.md |
| Result | BLOCKED |
| Exit code | 1 |
| Structural issues | 6 |
