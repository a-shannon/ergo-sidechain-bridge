...
| Field | Value |
|---|---|
| Command | npm run benchmark:validate -- ../evidence/benchmarks/gate7-offline-structured-candidate-2026-06-26-0e3765fa.md --report-out <report.md> |
| Working directory | ergo-sidechain-bridge/relayer |
| Validated target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-06-26-0e3765fa.md |
| Result | BLOCKED |
| Exit code | 1 |
...
| Publication decision | 7 | Release-note/checklist updates, blocker closure, or claim-boundary decision fields are incomplete |
