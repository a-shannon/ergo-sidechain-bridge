# Benchmark Validate Three-Run Prep Blocker Report - 2026-06-25 - 5b2e9c15

This report records the current validator result for the three-run offline
...
| Field | Value |
|---|---|
| Command | `npm run benchmark:validate -- ../evidence/benchmarks/offline-showcase-three-run-prep-2026-06-25-5b2e9c15.md` |
| Working directory | `ergo-sidechain-bridge/relayer` |
| Validated target | `../evidence/benchmarks/offline-showcase-three-run-prep-2026-06-25-5b2e9c15.md` |
| Result | BLOCKED |
| Exit code | 1 |
...
The validator fails closed with structured blocker output. The three-run prep
...
The linked three-run measurement artifact advances repeated offline measurement
coverage, but it cannot close Gate 7 until it is promoted into a completed
benchmark evidence document with command-specific output evidence,
scenario-specific metric rows, sharded-lane statements, bottleneck rows,
publication-update evidence, and reviewer sign-off.
