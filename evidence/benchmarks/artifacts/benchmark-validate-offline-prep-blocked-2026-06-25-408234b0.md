# Benchmark Validate Offline Prep Blocker Report - 2026-06-25 - 408234b0

This report records the current validator result for the existing offline
...
| Field | Value |
|---|---|
| Command | `npm run benchmark:validate -- ../evidence/benchmarks/offline-showcase-prep-2026-06-24-4b54dcff.md` |
| Working directory | `ergo-sidechain-bridge/relayer` |
| Validated target | `../evidence/benchmarks/offline-showcase-prep-2026-06-24-4b54dcff.md` |
| Result | BLOCKED |
| Exit code | 1 |
...
The validator now fails closed with structured blocker output. The offline prep
