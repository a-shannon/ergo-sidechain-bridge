# npm run wasm:test Command Output - 2026-07-03 - bcb15f7a
...
The benchmark code baseline for this evidence packet is `bcb15f7a`; this
command was rerun during the Gate 7 evidence refresh cycle and produced the
summary above.
