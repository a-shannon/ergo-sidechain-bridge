# Gate 7 Live Batch Benchmark Prerequisite Map - bcb15f7a
...
| Field | Value |
| --- | --- |
| Validator commit | bcb15f7a |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-bcb15f7a.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-03-bcb15f7a.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-bcb15f7a.md --validator-commit bcb15f7a --validator-report-out <report.md> --out <map.md>` |
