# Gate 7 Live Benchmark Review Packet - 05f25f0e
...
| Prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-08-05f25f0e.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-08-05f25f0e.md --validator-commit 05f25f0e --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
