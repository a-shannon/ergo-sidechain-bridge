# Gate 7 Live Benchmark Review Packet - 866ea4f4
...
| Prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-03-866ea4f4.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-866ea4f4.md --validator-commit 866ea4f4 --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
