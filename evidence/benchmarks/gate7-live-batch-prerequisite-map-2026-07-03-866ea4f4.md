# Gate 7 Live Batch Benchmark Prerequisite Map - 866ea4f4
...
| Field | Value |
| --- | --- |
| Validator commit | 866ea4f4 |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-866ea4f4.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-03-866ea4f4.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-866ea4f4.md --validator-commit 866ea4f4 --validator-report-out <report.md> --out <map.md>` |
