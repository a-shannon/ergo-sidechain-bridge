# Gate 7 Live Benchmark Review Packet - 37d1f8f7
...
| Prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-03-37d1f8f7.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-37d1f8f7.md --validator-commit 37d1f8f7 --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
