# Gate 7 Live Batch Benchmark Prerequisite Map - 8100681e
...
| Field | Value |
| --- | --- |
| Validator commit | 8100681e |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-8100681e.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-03-8100681e.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-03-8100681e.md --validator-commit 8100681e --validator-report-out <report.md> --out <map.md>` |
