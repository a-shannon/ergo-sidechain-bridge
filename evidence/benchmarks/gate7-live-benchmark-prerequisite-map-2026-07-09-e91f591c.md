# Gate 7 Live Batch Benchmark Prerequisite Map - e91f591c
...
| Field | Value |
| --- | --- |
| Validator commit | e91f591c |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-08-05f25f0e.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-gate7-current-prereq-blocked-2026-07-09-e91f591c.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-08-05f25f0e.md --validator-commit e91f591c --validator-report-out <report.md> --out <map.md>` |
