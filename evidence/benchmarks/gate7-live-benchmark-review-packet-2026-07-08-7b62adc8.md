# Gate 7 Live Benchmark Review Packet - 7b62adc8
...
| Prerequisite map | ../evidence/benchmarks/gate7-live-batch-prerequisite-map-2026-07-08-7b62adc8.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-08-7b62adc8.md --validator-commit 7b62adc8 --validator-report-out <report.md> --out <map.md> --review-packet-out <packet.md>` |
