# Gate 7 Live Batch Benchmark Prerequisite Map - dc64fb20
...
| Field | Value |
| --- | --- |
| Validator commit | dc64fb20 |
| Candidate target | ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-05-dc64fb20.md |
| Validator report | ../evidence/benchmarks/artifacts/benchmark-validate-offline-structured-candidate-blocked-2026-07-05-dc64fb20.md |
| Command | `npm run benchmark:prerequisite-map -- --candidate ../evidence/benchmarks/gate7-offline-structured-candidate-2026-07-05-dc64fb20.md --validator-commit dc64fb20 --validator-report-out <report.md> --out <map.md>` |
