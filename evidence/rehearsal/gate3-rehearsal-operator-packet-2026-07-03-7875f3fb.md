# Gate 3 Rehearsal Operator Packet - 7875f3fb
...
| Field | Value |
| --- | --- |
| Validator commit | 7875f3fb |
| Candidate target | ../docs/live-rehearsal-template.md |
| Prerequisite map | ../evidence/rehearsal/gate3-rehearsal-prerequisite-map-2026-07-03-7875f3fb.md |
| Command | `npm run rehearsal:prerequisite-map -- --candidate ../docs/live-rehearsal-template.md --validator-commit 7875f3fb --validator-report-out <report.md> --out <map.md> --operator-packet-out <packet.md>` |
