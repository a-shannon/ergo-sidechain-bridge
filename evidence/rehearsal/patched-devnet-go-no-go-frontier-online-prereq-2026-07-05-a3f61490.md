# Patched Devnet Frontier-Online Prerequisite Diagnostic - 2026-07-05 - a3f61490

This evidence records a current-head safe, read-only prerequisite diagnostic
for a future local patched-devnet lifecycle rehearsal with the configured
Frontier sidechain started locally and responding on JSON-RPC. Local source and
binary paths are not serialized. This is not completed Gate 3 lifecycle
evidence.
...
| `npm run demo:patched-devnet:go-no-go -- --skip-runtime-state-checks --ergo-source-root <configured-ergo-source-root> --frontier-binary <configured-frontier-binary> --json-out ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-frontier-online-prereq-2026-07-05-a3f61490.json` | LOCAL_PREREQS_OK / exit code 0 | [frontier-online prerequisite JSON](artifacts/patched-devnet-go-no-go-frontier-online-prereq-2026-07-05-a3f61490.json) |
| `npm run demo:patched-devnet:go-no-go:validate -- ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-frontier-online-prereq-2026-07-05-a3f61490.json` | PASS / exit code 0 | [validation output](artifacts/patched-devnet-go-no-go-frontier-online-prereq-validation-2026-07-05-a3f61490.md) |
