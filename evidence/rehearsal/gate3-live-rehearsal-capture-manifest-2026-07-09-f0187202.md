# Gate 3 Live Rehearsal Capture Manifest - f0187202
...
`npm run rehearsal:capture-manifest -- --source-commit f0187202 --prerequisite-map ../evidence/rehearsal/gate3-rehearsal-prerequisite-map-2026-07-09-1dd194a8.md --operator-packet ../evidence/rehearsal/gate3-rehearsal-operator-packet-2026-07-09-1dd194a8.md --live-template ../docs/live-rehearsal-template.md --operator-runbook ../docs/operator-runbooks.md --readiness-request ../evidence/readiness/readiness-operator-request-current-lanes-2026-07-07-89442919.md --patched-devnet-go-no-go-json ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-local-nodes-online-prereq-2026-07-07-3de8887a.json --patched-devnet-go-no-go-validation ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-local-nodes-online-prereq-validation-2026-07-07-3de8887a.md --out ../evidence/rehearsal/gate3-live-rehearsal-capture-manifest-2026-07-09-f0187202.md`

## Current Inputs

| Input | Current target | Capture status |
| --- | --- | --- |
| Source commit | `f0187202` | reference only |
| Gate 3 prerequisite map | ../evidence/rehearsal/gate3-rehearsal-prerequisite-map-2026-07-09-1dd194a8.md | BLOCKED with 65 structural issues |
| Gate 3 operator packet | ../evidence/rehearsal/gate3-rehearsal-operator-packet-2026-07-09-1dd194a8.md | BLOCKED; planning only |
...
| Current readiness operator request | ../evidence/readiness/readiness-operator-request-current-lanes-2026-07-07-89442919.md | remaining runtime inputs |
| Patched-devnet go/no-go JSON | ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-local-nodes-online-prereq-2026-07-07-3de8887a.json | LOCAL_PREREQS_OK; local prereqs only; execution not ready |
| Patched-devnet go/no-go validation | ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-local-nodes-online-prereq-validation-2026-07-07-3de8887a.md | PASS go/no-go prerequisite report: verdict=LOCAL_PREREQS_OK; not Gate 3 closure; not broadcast authorization; planning only |

## Capture Sequence

| Phase | Command or artifact to produce | Required concrete binding | Stop condition |
| --- | --- | --- | --- |
| Local 1. Patched-devnet go/no-go JSON | Linked current JSON: ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-local-nodes-online-prereq-2026-07-07-3de8887a.json; validated by ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-local-nodes-online-prereq-validation-2026-07-07-3de8887a.md; rerun npm run demo:patched-devnet:go-no-go and npm run demo:patched-devnet:go-no-go:validate if operator inputs, node config, runtime state, or funding change | LOCAL_PREREQS_OK patched-devnet prerequisite report, validation PASS, broadcast disabled, local non-mainnet endpoints classified, runtime-state checks explicitly skipped with execution-not-ready boundary, no secret environment dump | Block controlled execution until the report is rerun for current operator inputs, live local nodes, scoped funding, signer alignment, and runtime-state inspection, and still reports no unsafe broadcast state. |
