# Gate 3 Rehearsal Operator Packet - ec29b2ef
...
| Field | Value |
| --- | --- |
| Validator commit | ec29b2ef |
| Candidate target | ../docs/live-rehearsal-template.md |
| Prerequisite map | ../evidence/rehearsal/gate3-rehearsal-prerequisite-map-2026-07-06-ec29b2ef.md |
| Command | `npm run rehearsal:prerequisite-map -- --candidate ../docs/live-rehearsal-template.md --validator-commit ec29b2ef --validator-report-out <report.md> --out <map.md> --operator-packet-out <packet.md>` |
