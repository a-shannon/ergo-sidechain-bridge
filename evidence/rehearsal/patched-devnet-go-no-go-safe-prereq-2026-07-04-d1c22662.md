# Patched Devnet Safe Prerequisite Diagnostic - 2026-07-04 - d1c22662
...
|---|---|---|
| `npm run demo:patched-devnet:go-no-go -- --skip-runtime-state-checks --json-out ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-safe-prereq-2026-07-04-d1c22662.json` | NO-GO / exit code 1 | [safe prerequisite JSON](artifacts/patched-devnet-go-no-go-safe-prereq-2026-07-04-d1c22662.json) |
| `npm run demo:patched-devnet:go-no-go:validate -- ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-safe-prereq-2026-07-04-d1c22662.json` | PASS / exit code 0 | [validation output](artifacts/patched-devnet-go-no-go-safe-prereq-validation-2026-07-04-d1c22662.md) |
