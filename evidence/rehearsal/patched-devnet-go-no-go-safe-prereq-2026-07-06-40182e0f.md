# Patched Devnet Safe Prerequisite Diagnostic - 2026-07-06 - 40182e0f
...
|---|---|---|
| `npm run demo:patched-devnet:go-no-go -- --skip-runtime-state-checks --json-out ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-safe-prereq-2026-07-06-40182e0f.json` | NO-GO / exit code 1 | [safe prerequisite JSON](artifacts/patched-devnet-go-no-go-safe-prereq-2026-07-06-40182e0f.json) |
| `npm run demo:patched-devnet:go-no-go:validate -- ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-safe-prereq-2026-07-06-40182e0f.json` | PASS / exit code 0 | [validation output](artifacts/patched-devnet-go-no-go-safe-prereq-validation-2026-07-06-40182e0f.md) |
...
| FAIL checks | 2 | `../ergo-source` missing; `frontier-template-node.exe` missing at the configured default location |
...
| Next action | Restore or configure the patched Ergo source and Frontier binary, then rerun the same diagnostic before any scoped local rehearsal approval |
