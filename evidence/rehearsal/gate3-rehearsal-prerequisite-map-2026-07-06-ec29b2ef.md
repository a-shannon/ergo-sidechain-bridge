# Gate 3 Rehearsal Prerequisite Map - ec29b2ef
...
| Validator report | ../evidence/rehearsal/artifacts/rehearsal-validate-live-rehearsal-template-blocked-2026-07-06-ec29b2ef.md |
| Command | `npm run rehearsal:prerequisite-map -- --candidate ../docs/live-rehearsal-template.md --validator-commit ec29b2ef --validator-report-out <report.md> --out <map.md>` |
