# Gate 3 Recovery Drill Prerequisite Map - 2026-06-26 - 0325bc18
...
| State source | `sourceBindings.state.sourceType = read-only-state-tracker`; read-only true; runtimePathSerialized false; target class is default-state-db or operator-provided-state-db; no local path, runtime file, or secret material serialized |
