# Patched Devnet Current-HEAD Frontier-Configured Prerequisite Diagnostic - 2026-07-07 - 9223954d
...
|---|---|---|
| `npm run demo:patched-devnet:go-no-go -- --skip-runtime-state-checks --ergo-source-root <configured-ergo-source-root> --frontier-binary <configured-frontier-binary> --json-out ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-frontier-configured-prereq-2026-07-07-9223954d.json` | LOCAL_PREREQS_OK / exit code 0 | [frontier-configured prerequisite JSON](artifacts/patched-devnet-go-no-go-frontier-configured-prereq-2026-07-07-9223954d.json) |
| `<configured-frontier-binary> --version` | PASS / exit code 0 | `frontier-template-node.exe 0.0.0-75329a2df49` |
| `npm run demo:patched-devnet:go-no-go:validate -- ../evidence/rehearsal/artifacts/patched-devnet-go-no-go-frontier-configured-prereq-2026-07-07-9223954d.json` | PASS / exit code 0 | [validation output](artifacts/patched-devnet-go-no-go-frontier-configured-prereq-validation-2026-07-07-9223954d.md) |
...
| FAIL checks | 0 | None |
| Final verdict | 0 | `LOCAL_PREREQS_OK -- EXECUTION NOT READY` until live local nodes, scoped environment values, funding, signer alignment, runtime-state inspection, and explicit approval are handled |
