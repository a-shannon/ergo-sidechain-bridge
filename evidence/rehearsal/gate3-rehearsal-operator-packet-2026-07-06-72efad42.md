# Gate 3 Rehearsal Operator Packet - 72efad42
...
| Prerequisite map | ../evidence/rehearsal/gate3-rehearsal-prerequisite-map-2026-07-06-72efad42.md |
| Command | `npm run rehearsal:prerequisite-map -- --candidate ../docs/live-rehearsal-template.md --validator-commit 72efad42 --validator-report-out <report.md> --out <map.md> --operator-packet-out <packet.md>` |
