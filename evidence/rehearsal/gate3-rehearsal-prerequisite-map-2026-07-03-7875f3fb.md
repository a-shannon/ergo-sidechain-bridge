# Gate 3 Rehearsal Prerequisite Map - 7875f3fb
...
| Validator report | ../evidence/rehearsal/artifacts/rehearsal-validate-live-rehearsal-template-blocked-2026-07-03-7875f3fb.md |
| Command | `npm run rehearsal:prerequisite-map -- --candidate ../docs/live-rehearsal-template.md --validator-commit 7875f3fb --validator-report-out <report.md> --out <map.md>` |
