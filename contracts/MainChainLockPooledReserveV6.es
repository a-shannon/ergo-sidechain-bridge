{
  // MainChainLockPooledReserveV6 - refundable native-ERG staging for one
  // pooled-reserve V6 settlement-family instance.
  //
  // Registers:
  ...
  // same transaction as the exact reserve predecessor. The source lock
