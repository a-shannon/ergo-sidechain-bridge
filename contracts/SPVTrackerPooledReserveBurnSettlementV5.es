{
  // SPVTrackerPooledReserveBurnV5 - exact preactivation consumer for the
  // pooled-reserve burn statement V5.
  //
  ...
  //
  // Registers:
  //   R4: Coll[Byte] - exact pooled-reserve V5 settlement-lineage profile ID
