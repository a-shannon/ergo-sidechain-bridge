{
  ...
  // pooled-reserve V5 burn-proof family. It validates the authenticated V5
  // tracker value,
  ...
  //
  // Registers:
  //   R4: Coll[Byte] - exact pooled-reserve V5 family profile ID
  //   R5: AvlTree    - spent burn IDs (key=32, value=1)
  //
  // Transaction:
  //   DATA_INPUTS(0): exact V5 tracker singleton
