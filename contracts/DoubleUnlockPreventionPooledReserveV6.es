{
  ...
  // pooled-reserve V6 settlement family. It validates the retained V5 tracker
  // value, the tracker-included 205-byte burn leaf, Merkle inclusion, payout bindings, reserve
  ...
  //
  // Transaction:
  //   DATA_INPUTS(0): exact V6-lineage tracker singleton carrying V5 values
  ...
  // E2S_SPV_VALIDITY_APPLICATION_KEY_V5
  val trackerKeyDomain =
    fromBase16("4532535f5350565f56414c49444954595f4150504c49434154494f4e5f4b45595f5635")
  // E2S_SPV_VALIDITY_APPLICATION_VALUE_V5 plus a canonical NUL separator
