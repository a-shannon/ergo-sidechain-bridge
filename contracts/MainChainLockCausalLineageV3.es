{
  // MainChainLockCausalLineageV3 - refundable ERG staging for one
  // instance-resolved causal lineage.
  //
  // Register layout:
  ...
  val sidechainId = fromBase16("CAUSAL_SIDECHAIN_ID_HEX_PLACEHOLDER")
  val bridgeAddress = fromBase16("CAUSAL_BRIDGE_ADDRESS_HEX_PLACEHOLDER")
  val tokenAddress = fromBase16("CAUSAL_TOKEN_ADDRESS_HEX_PLACEHOLDER")
  val settlementProfileId =
    fromBase16("CAUSAL_SETTLEMENT_PROFILE_ID_HEX_PLACEHOLDER")
  val causalProfileId = fromBase16("CAUSAL_PROFILE_ID_HEX_PLACEHOLDER")
  val causalVaultContractId =
    fromBase16("CAUSAL_SETTLEMENT_VAULT_CONTRACT_ID_HEX_PLACEHOLDER")
